...
**If tests are missing:** Add behavior-driven tests first using [writing-tests.md](writing-tests.md).
...
**If something breaks:** STOP. Use [systematic-debugging.md](systematic-debugging.md). Don't proceed until understood.
